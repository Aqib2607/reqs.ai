    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto space-y-12">
          {steps.map((s, i) => (
            <div key={s.step} className="soft-card p-8 hover-lift">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 rounded-xl bg-secondary/20 border border-secondary/40 flex items-center justify-center">
                    <s.icon className="w-8 h-8 text-secondary-dark" />
                  </div>
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-3xl font-black text-secondary-dark/60">{s.step}</span>
